"""Step-policy program figures for the dashboard (2026-08-16 session):
  ...
  figures/dashboards/misc/step_alpha_h_trainobj.png   5-seed dash training objective bar
                                      (auto / fixed 0.5 / adagrad a0=1)
  figures/dashboards/misc/step_alpha_h2_trainobj.png  7-arm 2-seed bar (+ alpha0 grid, DoG)
  figures/dashboards/misc/adastep_ladder.png          ADASTEP ladder smoke vs the original
