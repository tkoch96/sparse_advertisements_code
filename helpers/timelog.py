...
def activate():
    ...
    import core.optimal_adv_wrapper as oaw
    import core.sparse_advertisements_v3 as sas3
    import core.path_distribution_computer as pdc
    ...
    try:
        import core.worker_comms as wcr
