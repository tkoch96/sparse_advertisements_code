"""Unit tests for the worker-actor death recovery (worker_comms) and the
...
# Importing worker_comms triggers a local ray.init (idempotent). We never
# create real actors here; ray.kill / ray.cluster_resources are monkeypatched.
import core.worker_comms as wc
from core.worker_comms import Worker_Manager, _ACTOR_DEATH_EXC
