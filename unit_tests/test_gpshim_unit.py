...
matrix assembly is independent, so facade lowering bugs can't cancel).
    ...
    SCULPTOR_LP_BACKEND=highs python -m unit_tests.test_gpshim_unit
"""
import os
import sys
...
import pytest
# salvaged from experiments/solver_fork 2026-08-21; marked so the default
# `pytest -m unit` suite actually runs it.
