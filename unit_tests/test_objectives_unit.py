"""No-Gurobi unit tests for core/hard_objectives.py.
...
the objectives can be trusted before any Gurobi/worker wiring.
    ...
    ~/Documents/venv312/bin/python -m pytest old_handoffs/MODEL_UNCERTAINTY_DIMENSIONS.md/test_objectives_unit.py -q
"""
import os
import sys
...
import pytest
# salvaged from old_handoffs/MODEL_UNCERTAINTY_DIMENSIONS.md 2026-08-21; marked so `pytest -m unit`
# actually runs it. Covers core/hard_objectives.py (no Gurobi needed).
