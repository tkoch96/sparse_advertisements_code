...
`path_distribution_computer.py:66` opens `logs/worker_X_log-<dpsize>.txt`
...
- [worker_comms.py:140](worker_comms.py:140) caps at
...
[worker_comms.py:145-173 `start_workers`](worker_comms.py:145)
...
1. **`SCULPTOR_N_WORKERS` env var override** in
   [worker_comms.py:134](worker_comms.py:134). The original heuristic
